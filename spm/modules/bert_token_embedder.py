...
# @Date:   2019-04-10 12:10:30
# @Last Modified by:  Shuailong
# @Last Modified time: 2019-04-10 12:28:02

"""
Based on allennlp implementation. Add projection layer
"""
import logging
...
class BertEmbedder(TokenEmbedder):
    ...
    projection_dim : ``int``, optional
        If given, we will project the Bert embedding down to this dimension.
    """
    ...
    def __init__(self, bert_model: BertModel,
        ...
        if projection_dim:
            self._projection = torch.nn.Linear(
                bert_model.config.hidden_size, projection_dim)
    ...
    def forward(self,
        ...
        if offsets is None:
            ...
            res = util.uncombine_initial_dims(mix, input_ids.size())
        else:
            ...
            res = util.uncombine_initial_dims(
