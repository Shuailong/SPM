...
local batch_size_base = 32; // 6g GPU mem required
local batch_size_large = 32; // 15g GPU mem required
...

{
    ...
    "train_data_path": data_root + "/sst/SST-2/train.tsv",
    "validation_data_path": data_root + "/sst/SST-2/dev.tsv",
    // "test_data_path": data_root + "/sst/SST-2/test.tsv",
